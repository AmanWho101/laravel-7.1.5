...
<table class="table table-striped table-bordered" id="items-table" width="100%">
    ...
    @foreach($items as $item)
        <tr>
            ...
            <td>{!! $item->name_iu !!}</td>
            <td>
                 <a href="{{ route('admin.item.items.show', collect($item)->first() ) }}">
                     <i class="livicon" data-name="info" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="view item"></i>
                 </a>
                 {{-- <a href="{{ route('admin.item.items.edit', collect($item)->first() ) }}">
                     <i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="edit item"></i>
                 </a> --}}
                 <a href="{{ route('admin.item.items.confirm-delete', collect($item)->first() ) }}" data-toggle="modal" data-target="#delete_confirm" data-id="{{ route('admin.item.items.delete', collect($item)->first() ) }}">
