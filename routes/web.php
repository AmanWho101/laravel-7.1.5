...
//employe
Route::group(
    ['prefix' => 'employee', 'namespace' => 'Employee'],
    function () {
        Route::get('signin', 'AuthController@getSignin')->name('designin');
        Route::post('signin', 'AuthController@postSignin')->name('depostSignin');
        Route::get('logout', 'AuthController@getLogout')->name('.logout');
    }
);
Route::group(
    ['prefix' => 'employee', 'middleware' => 'employee', 'as' => 'employee.'],
    function () {
        // Dashboard / Index
        Route::get(
            'dashboard',
